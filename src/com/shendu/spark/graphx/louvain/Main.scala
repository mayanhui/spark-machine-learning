package com.shendu.spark.graphx.louvain
...
case class Config(
    ...
    input:String = "/home/zkpk/workspace-scala/spark-machine-learning/examples/small_edges.tsv",
    //output: String = "/data/weibo_data/result",
    //output: String = "/user/ningliu/result",
    output: String = "/home/zkpk/workspace-scala/spark-machine-learning/examples/out",
