package com.shendu.spark.mllib.kmeans
...
object KMeansClustering {
  ...
  def main(args:Array[String]){
   ...
   /**
    ...
    //1. Cluster the data into two classes using KMeans
    ...
    //2. begin to check which cluster each test data belongs to based on the clustering result
